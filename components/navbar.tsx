...
//               <Button variant="ghost" size="icon" className="md:hidden rounded-full w-15 h-12 p-0">
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          {/* Logo */}
          <Link href="/" className="flex items-center space-x-2">
            <Image src="/assets/lumereg-logo.png" alt="Logo" width={100} height={40} />
          </Link>
            ...
            <Sheet open={isOpen} onOpenChange={setIsOpen}>
              ...
              <SheetContent side="right" className="w-[300px] sm:w-[400px]">
                <div className="flex flex-col space-y-4 mt-8">
                  ...
                  >
                    <Button
                      className="bg-purple-600 hover:bg-purple-700 rounded-full w-full mt-4"
                      onClick={() => setIsOpen(false)}
                    >
                      Donate Now
                    </Button>
